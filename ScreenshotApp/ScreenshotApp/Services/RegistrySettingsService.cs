...
public class RegistrySettingsService : ISettingsService
{
    ...
    public string LastAnnotationColor
    {
        get => _settings.LastAnnotationColor;
        set
        {
            if (_settings.LastAnnotationColor != value)
            {
                _settings.LastAnnotationColor = value;
                OnSettingsChanged();
            }
        }
    }
    ...
    public void Load()
    {
        try
        {
            ...
            if (key != null)
            {
                ...
                if (key.GetValue("LastAnnotationColor") is string lastColor)
                {
                    _settings.LastAnnotationColor = lastColor;
                }
            }
        }
        catch (Exception ex)
    ...
    public void Save()
    {
        try
        {
            ...
            if (key != null)
            {
                ...
                key.SetValue("LastAnnotationColor", _settings.LastAnnotationColor, RegistryValueKind.String);
            }
        }
        catch (Exception ex)
        {
    ...
    public void ResetToDefaults()
    {
        ...
        _settings.LastAnnotationColor = defaults.LastAnnotationColor;
        OnSettingsChanged();
    }
